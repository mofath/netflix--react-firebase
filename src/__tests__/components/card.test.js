...
describe("<Card />", () => {
  let container, queryByText, getByAltText, getByTestId, getByText;
  let category = "series";
  ...
  beforeEach(() => {
    ...
    getByAltText = queries.getByAltText;
  ...
  it("renders the <Card /> component and toggles the card feature", () => {
